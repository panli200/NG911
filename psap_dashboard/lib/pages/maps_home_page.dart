...
class _MapsHomePageState extends State<MapsHomePage> {
  ...
  Widget build(BuildContext context) => Scaffold (
    backgroundColor: 
      Colors.grey[100],
    drawer: 
      NavigationDrawerWidget(name: name),
      appBar: 
        AppBar
        (
              ...
              (
                ...
                child:
                  ...
                  (
                    ...
                    children: <Widget>[
                      ...
                      (
                        ...
                        [
                          ...
                          (
                            height: 200.0,
                            child: StreamBuilder<QuerySnapshot> // This will read the Waiting list from Firebase (SOSEmergencies)
                            ( 
                              stream: Waiting,
                    ...
                    const Text('Online List', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20), textAlign: TextAlign.center),
